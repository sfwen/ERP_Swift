...
@objc public enum SliderViewIndicatorType: Int {
    case normal
    case stretch
    case stretchAndMove
}

@objc public protocol SliderViewContainerDelegate: NSObjectProtocol {
    @objc optional func reloadView()
}
@objc public protocol SliderViewDelegate: NSObjectProtocol {
    @objc optional func sliderView_switchToTab(currentIndex: Int)
}
public class SliderView: UIView {
    
    @objc public weak var delegate: SliderViewDelegate?
    //MARK: - properties
    
    public private(set) var titles: [String] = []
    
    public private(set) var controllers: [UIViewController & SliderViewContainerDelegate] = []
    ...
    //下标切换动画
    private var indicatorType: SliderViewIndicatorType = .normal
    ...
    //MARK: - 参数初始化
    @objc public init(frame: CGRect,titles: [String],childControllers: [UIViewController & SliderViewContainerDelegate]) {
    ...
    //MARK: - 参数初始化
    @objc public init(frame: CGRect, indicatorType: SliderViewIndicatorType, titles: [String],childControllers: [UIViewController & SliderViewContainerDelegate]) {
    ...
    private func initUI() {
        ...
        tabScrollView.centerX = self.centerX
    ...
    //MARK: - 内容UI更新
    @objc public func reloadView(titles: [String],controllers: [UIViewController & SliderViewContainerDelegate] ) {
