...
class ContactMainViewController: UIViewController {
    ...
    func loadContactsData() -> Void {
        ...
        let keys = [CNContactFamilyNameKey, CNContactGivenNameKey, CNContactNicknameKey,
                    ...
                    CNContactNoteKey, CNContactPhoneNumbersKey, CNContactEmailAddressesKey, CNContactPostalAddressesKey,
